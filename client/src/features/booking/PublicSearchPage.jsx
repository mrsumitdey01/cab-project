    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 relative z-10">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex items-center gap-2 bg-[#1DA851] hover:bg-[#158c42] text-white px-6 py-2.5 rounded-full font-semibold shadow-[0_4px_12px_rgba(29,168,81,0.3)] hover:shadow-[0_6px_16px_rgba(29,168,81,0.4)] hover:-translate-y-0.5 transition-all duration-200"
          >
          ...
          <button
            type="button"
            className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-[0_4px_12px_rgba(59,130,246,0.3)] hover:shadow-[0_6px_16px_rgba(59,130,246,0.4)] hover:-translate-y-0.5 transition-all duration-200"
          >
