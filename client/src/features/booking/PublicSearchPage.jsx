    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div ref={contactBarRef} className="w-full flex flex-col sm:flex-row items-center justify-center gap-4 mb-6 relative z-10">
        ...
        <div className="flex gap-3">
          <button
            type="button"
            className="flex items-center gap-2 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-[0_6px_18px_rgba(16,185,129,0.35)] hover:shadow-[0_8px_22px_rgba(16,185,129,0.45)] hover:-translate-y-0.5 transition-all duration-200"
          >
          ...
          <button
            type="button"
            className="flex items-center gap-2 bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-[0_6px_18px_rgba(59,130,246,0.35)] hover:shadow-[0_8px_22px_rgba(59,130,246,0.45)] hover:-translate-y-0.5 transition-all duration-200"
          >
